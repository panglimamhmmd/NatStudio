...
function Card({ quote, tag, ph }: Item & { ph: string }) {
  return (
    <article className="group flex h-full min-h-[188px] w-72 shrink-0 flex-col rounded-md border border-line bg-card p-5 transition-all duration-300 hover:z-10 hover:scale-[1.03] hover:border-accent hover:bg-card-hi sm:w-80 sm:min-h-[176px] sm:p-6">
