      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <Reveal>
          ...
          <h2 className="display-type mt-3 max-w-2xl text-3xl font-extrabold leading-[1.1] tracking-tight sm:text-5xl">
            {t.location.titleA}{" "}
            <GradientText className="heading-accent">{t.location.titleB}</GradientText>
          </h2>
        ...
        <div className="mt-10 grid gap-4 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.2fr)]">
          <Reveal className="flex flex-col justify-between rounded-lg border border-line bg-card p-6 sm:p-8">
            <div>
          ...
          <Reveal
            delay={100}
            className="relative aspect-4/3 overflow-hidden rounded-lg border border-line sm:aspect-16/10"
          >
            <iframe
              src={MAP_SRC}
