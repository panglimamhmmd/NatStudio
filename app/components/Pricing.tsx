      ...
      <div className="mt-10 grid gap-4 md:grid-cols-3">
        {t.pricing.tiers.map((tier, i) => (
          <Reveal key={tier.name} delay={i * 100} className="h-full">
            <article
              className={`flex h-full flex-col rounded-md border bg-card p-6 transition-all duration-300 hover:scale-[1.02] sm:p-8 ${
                tierMeta[i].featured
            ...
            >
              ...
              <a
                ...
                className={`mt-7 rounded-md px-5 py-2.5 text-center text-sm font-semibold transition-all hover:scale-[1.03] ${
                  tierMeta[i].featured
