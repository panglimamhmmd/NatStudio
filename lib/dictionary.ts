...
const en = {
  ...
  work: {
    ...
    sub: "A few frames from recent shoots. Client and campaign under each frame. Tap or hover to develop the print.",
    frames: [
    ...
    reasons: [
      {
        ...
        copy: "In the digital era, video carries the pitch. That matters even more for property, where you're selling trust, not just a unit.",
      },
      {
        tag: "NO TEAM",
  ...
  testimonials: {
    ...
    items: [
      { quote: "Honestly, I stopped thinking about content. Stuff shows up, I approve it, it gets posted.", tag: "Client, F&B" },
      { quote: "We've booked them three times now. Every shoot date held, and revisions never turned into a back-and-forth.", tag: "Client, Skincare" },
      { quote: "I was skeptical about doing this remote. Turned out cleaner than the local crews we used to hire.", tag: "Client, Fashion" },
      { quote: "Six months in and content still lands every month, on time.", tag: "Client, Coffee Shop" },
      { quote: "We're a small team. Not having to think about content is what let us actually focus on selling.", tag: "Client, Fitness Studio" },
      { quote: "What I liked most: the price was clear from day one. No line items showing up later.", tag: "Client, Furniture" },
      { quote: "Gave them one brief and they just ran with it, all the way to done.", tag: "Client, Hospitality" },
      { quote: "Revisions took one comment on the link. Fixed, no meeting needed.", tag: "Client, Retail" },
      { quote: "The same content works for our ads too, and it still looks like us.", tag: "Client, Automotive" },
      { quote: "My favorite part? I don't have to chase updates. They send them before I ask.", tag: "Client, Education" },
    ],
  },
  location: {
...
const id: typeof en = {
  ...
  work: {
    ...
    sub: "Beberapa frame dari shooting terakhir. Nama klien dan campaign di bawah tiap frame. Tap atau arahkan kursor untuk mencuci fotonya.",
    frames: [
    ...
    seeMore: "Lihat karya lainnya di Instagram",
  },
  why: {
  ...
  testimonials: {
    ...
    items: [
      { quote: "Jujur, saya udah nggak mikirin konten lagi. Tinggal muncul, saya approve, langsung posting.", tag: "Klien, F&B" },
      { quote: "Udah tiga kali order sama mereka. Tanggal shooting selalu tepat, revisi nggak pernah muter-muter.", tag: "Klien, Skincare" },
      { quote: "Awalnya saya ragu sistem remote. Eh, hasilnya malah lebih rapi dari crew lokal yang biasa kami pakai.", tag: "Klien, Fashion" },
      { quote: "Udah jalan enam bulan, kontennya tetap konsisten tiap bulan, nggak pernah telat.", tag: "Klien, Kedai Kopi" },
      { quote: "Tim kami kecil. Nggak mikirin konten lagi itu yang bikin kami bisa fokus jualan.", tag: "Klien, Fitness Studio" },
      { quote: "Yang paling saya suka, harganya jelas dari awal. Nggak ada biaya nongol belakangan.", tag: "Klien, Furniture" },
      { quote: "Kami kasih satu brief, sisanya mereka yang jalanin sampai selesai.", tag: "Klien, Hospitality" },
      { quote: "Revisinya cukup satu komen di link, langsung dibenerin. Nggak perlu meeting.", tag: "Klien, Retail" },
      { quote: "Konten yang sama kepake buat ads juga, dan tetap kelihatan seperti brand kami.", tag: "Klien, Otomotif" },
      { quote: "Paling favorit? Nggak perlu ngejar update. Mereka yang update duluan.", tag: "Klien, Edukasi" },
    ],
  },
  location: {
